...
public:
     ...
     * Depending on m_logRawTexture this is logarithmic or not.
     *
     ...
     * \return \c return raw texture of the histogram
     */
    unsigned char* getRawTextureLinear();
    ...
    */
    ...
    /**
     * Select whether raw texture should be returned logarithmically
     *
     * \param log Logarithmically or not?
     */
    void setLogRawTexture( bool log );
...
private:
    ...
    bool m_logRawTexture; //!< Return raw texture logarithmically.
};
