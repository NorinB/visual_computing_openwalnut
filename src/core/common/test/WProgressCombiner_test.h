...
public:
    ...
    */
    ...
    void testWithChilds()
    {
        ...
        std::shared_ptr< WProgress> p1( new WProgress( "TestP1", 11 ) );
        std::shared_ptr< WProgress> p2( new WProgress( "TestP2", 11 ) );
        std::shared_ptr< WProgress> p3( new WProgress( "TestP3" ) );
