    ...
    m_localPath( WPathHelper::getSharePath() )
{
    ...
    m_runtimeName = m_properties->addProperty( "Name", "The name of the module as defined by the user. This is the module name by default, but can "
                                                       "be changed by users to provide a simple means of identification when using many modules.",
                                                       std::string( "" ), false );
