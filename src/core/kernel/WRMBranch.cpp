...
{
    m_properties = std::shared_ptr< WProperties >( new WProperties( "Properties", "This branch's properties" ) );
    ...
    m_changeRoiSignal = std::shared_ptr< boost::function< void() > >( new boost::function< void() >( boost::bind( &WRMBranch::setDirty, this ) ) );
}
