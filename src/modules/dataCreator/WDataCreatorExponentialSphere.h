...
#ifndef WDATACREATOREXPONENTIALSPHERE_H
#define WDATACREATOREXPONENTIALSPHERE_H
 ...
 */
class WDataCreatorExponentialSphere: public WObjectNDIP< WDataSetSingleCreatorInterface >
{
public:
    /**
     * Default constructor.
     */
    WDataCreatorExponentialSphere();

    /**
     * Destructor.
     */
    virtual ~WDataCreatorExponentialSphere();
...
#endif  // WDATACREATOREXPONENTIALSPHERE_H
