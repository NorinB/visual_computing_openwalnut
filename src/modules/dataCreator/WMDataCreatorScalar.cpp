                ...
                "Creator", "A list of all known creators." )
{
    ...
    m_strategy.addStrategy( WDataCreatorExponentialSphere::SPtr( new WDataCreatorExponentialSphere() ) );
    ...
    m_strategy.addStrategy( WDataCreatorLinearAscent::SPtr( new WDataCreatorLinearAscent() ) );
    m_strategy.addStrategy( WDataCreatorConstant::SPtr( new WDataCreatorConstant() ) );
    m_strategy.addStrategy( WDataCreatorTuring::SPtr( new WDataCreatorTuring() ) );
