...
public:
     ...
     * \param partitionValuesPointer vector where to save the partition quality values
     * \param patitionVectorPointer vector where to save the partition actual partitions
