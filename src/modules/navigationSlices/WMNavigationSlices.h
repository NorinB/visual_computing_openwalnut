...
#include "core/graphicsEngine/WPickInfo3D.h"
...
private:
    ...
    private:
        ...
        /**
         * 3D Pick event handler. Uses for dragging the slices
         *
         * \param pickInfo the pick information.
         */
        void pick3D( std::pair< WPickInfo3D, WPickInfo3D > pickInfo );
        ...
        /**
         * The 3d pick connection for the pick() event handler.
         */
        boost::signals2::scoped_connection m_pickConnection3D;
        ...
        /**
         * If true, the item is still picked in 3D.
         */
        bool m_isPicked3D;
        ...
        /**
         * The old pick information for 3D
         */
        std::pair< WPickInfo3D, WPickInfo3D > m_oldPickInfo3D;
