...
const std::string WMSurfaceParameterAnimator::getDescription() const
{
    ...
    return "This module can show parameters defined on surfaces using various types of animation."
        " See paper http://dx.doi.org/10.2312/PE/VMV/VMV10/155-162";
}
...
osg::ref_ptr< osg::Node > WMSurfaceParameterAnimator::renderSurface( const WBoundingBox& bbox )
{
    ...
    osg::ref_ptr< osg::Uniform > size1 = new osg::Uniform( "u_size1", m_size1->get() );
    osg::ref_ptr< osg::Uniform > size2 = new osg::Uniform( "u_size2", m_size2->get() );
    size1->setUpdateCallback( new SafeUniformCallback( this ) );
    size2->setUpdateCallback( new SafeUniformCallback( this ) );

    osg::ref_ptr< osg::Uniform > speed1 = new osg::Uniform( "u_speed1", m_speed1->get() );
    osg::ref_ptr< osg::Uniform > speed2 = new osg::Uniform( "u_speed2", m_speed2->get() );
    speed1->setUpdateCallback( new SafeUniformCallback( this ) );
    speed2->setUpdateCallback( new SafeUniformCallback( this ) );

    osg::ref_ptr< osg::Uniform > paramScale = new osg::Uniform( "u_parameterScale", m_parameterScale->get() );
    paramScale->setUpdateCallback( new SafeUniformCallback( this ) );

    osg::ref_ptr< osg::Uniform > saturation = new osg::Uniform( "u_saturation", static_cast< float >( m_saturation->get() / 100.0 ) );
