...
#ifndef WMTRANSFERFUNCTION2D_H
#define WMTRANSFERFUNCTION2D_H
 ...
 * \ingroup modules
 */
class WMTransferFunction2D: public WModule
{
public:
    /**
     * Constructor
...
nnectors must not be handled by the module.
    ...
    /**
     * Resolution of the transfer function in x and y.
     */
    ...
    /**
     * The transfer function editor property.
     */
    WPropTransferFunction2D m_transferFunction;

    WPropBool m_logHistogram;  //!< Show logarithmic histogram instead of linear.
};

#endif  // WMTRANSFERFUNCTION2D_H
