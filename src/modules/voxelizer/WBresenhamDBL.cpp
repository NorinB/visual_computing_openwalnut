...
WBresenhamDBL::WBresenhamDBL( std::shared_ptr< WGridRegular3D > grid, VoxelCompositionType compositionType, bool antialiased )
    : WBresenham( grid, compositionType, antialiased )
{
}
