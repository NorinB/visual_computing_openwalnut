...
bool WMainWindow::projectSave( const std::vector< std::shared_ptr< WProjectFileIO > >& writer, const bool useLastFileName )
{
    ...
    else
    {
        ...
        QString selected = QFileDialog::getSaveFileName( this, "Save Project as", lastPath,
                                                         "Project File (*.owproj *.owp)", nullptr, QFileDialog::DontUseNativeDialog );
        if( selected == "" )
        {
            return false;
        }
...
void WMainWindow::openLoadDialog()
{
    ...
    QStringList filenames = QFileDialog::getOpenFileNames( this, "Open Data, Project or Script", lastPath, filters, nullptr,
...
{
    WProjectFile::SPtr proj( new WProjectFile( filename, boost::bind( &WMainWindow::slotLoadFinished,
                                                                      this,
...
void WMainWindow::switchVisibility( QObject* who )
{
    QWidget* w = dynamic_cast< QWidget* >( who );
    if( w )
    {
