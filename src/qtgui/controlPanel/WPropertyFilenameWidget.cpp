...
void WPropertyFilenameWidget::buttonReleased()
{
    ...
    QFileDialog::Options options = m_fnProperty->countConstraint( PC_CONFIRMOVERWRITE ) != 0 ?
                                            QFileDialog::DontUseNativeDialog : QFileDialog::DontUseNativeDialog | QFileDialog::DontConfirmOverwrite;
