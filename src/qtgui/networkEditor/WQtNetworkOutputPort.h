...
public:
     ...
     */
    explicit WQtNetworkOutputPort( std::shared_ptr<WModuleOutputConnector> connector );
...
private:
    std::shared_ptr<WModuleOutputConnector> m_connector; //!< the related WModuleInputConnector
};
