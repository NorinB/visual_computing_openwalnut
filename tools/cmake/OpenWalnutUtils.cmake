...
# The "hard" stylecheck stops after the first encoutered error
...
FUNCTION( SETUP_STYLECHECKER _TargetName _CheckFiles _Excludes )
    ...
    # add a new hard stylecheck target for this lib
    ADD_CUSTOM_TARGET( stylecheckHard_${_TargetName}
    ...
    # add a new stylecheck target for this lib
   ...
   ADD_DEPENDENCIES( stylecheckHard "stylecheckHard_${_TargetName}" )
